...
interface WorkflowStep {
  title: string;
  description: string;
  actor: 'user' | 'system' | 'admin' | 'external';
  duration: string;
}
...
interface Workflow {
  id: string;
  name: string;
  type: 'business' | 'user' | 'system' | 'approval';
  description: string;
  trigger: string;
  steps: WorkflowStep[];
  ...
  priority: 'low' | 'medium' | 'high' | 'critical';
  frequency: 'rare' | 'monthly' | 'weekly' | 'daily' | 'frequent';
...
@Component({
      ...
      <div class="content-container" [ngSwitch]="activeTab()">
        ...
        <div *ngSwitchCase="'user-stories'" class="unified-tab">
          <div class="tab-header">
            ...
            <p class="main-subtitle">Create and manage user stories for your project</p>
          </div>
          <div class="tab-content">
            <div class="content-section">
              <h3 class="subsection-title">📖 User Stories</h3>
              <p>User Stories functionality coming soon...</p>
            </div>
          </div>
        </div>
        ...
        <div *ngSwitchCase="'workflows'" class="unified-tab">
          <div class="tab-header">
            ...
            <p class="main-subtitle">Define business processes and user workflows</p>
          </div>
          <div class="tab-content">
            <div class="content-section">
              <h3 class="subsection-title">🔄 Workflows</h3>
              <p>Workflows functionality coming soon...</p>
            </div>
          </div>
        </div>
  ...
  ,
                    ...
                    <button type="button" class="remove-btn" (click)="removeUserStory(i)">❌</button>
                  </div>

                  <div class="story-content">
                    <div class="form-group">
                      <label>As a (User Type):</label>
                      <input type="text" [(ngModel)]="story.userType" placeholder="e.g., customer, admin, visitor" class="form-control">
                    </div>

                    <div class="form-group">
                      <label>I want to (Action):</label>
                      <textarea [(ngModel)]="story.action" placeholder="Describe what the user wants to do..." class="form-control" rows="2"></textarea>
                    </div>

                    <div class="form-group">
                      <label>So that (Benefit):</label>
                      <textarea [(ngModel)]="story.benefit" placeholder="Explain the value or benefit..." class="form-control" rows="2"></textarea>
                    </div>

                    <div class="form-group">
                      <label>Acceptance Criteria:</label>
                      <textarea [(ngModel)]="story.acceptanceCriteria" placeholder="Define when this story is considered complete..." class="form-control" rows="3"></textarea>
                    </div>

                    <div class="story-meta-fields">
                      <div class="meta-field">
                        <label>Story Points:</label>
                        <select [(ngModel)]="story.storyPoints" class="form-control">
                      ...
                      <div class="meta-field">
                        <label>Epic:</label>
                        <input type="text" [(ngModel)]="story.epic" placeholder="Epic name" class="form-control">
                      </div>

                      <div class="meta-field">
                        <label>Status:</label>
                        <select [(ngModel)]="story.status" class="form-control">
                ...
                <div *ngIf="userStories().length === 0" class="empty-state">
                  <div class="empty-icon">📖</div>
                  <h3>No User Stories Yet</h3>
                  <p>Start by adding your first user story to define what users need from your system.</p>
                  <button type="button" class="action-btn primary" (click)="addUserStory()">
        ...
        <div *ngSwitchCase="'workflows'" class="unified-tab">
          ...
          <div class="tab-content">
            <div class="content-section">
              <div class="section-header">
                <h3 class="subsection-title">🔄 Project Workflows</h3>
                <button type="button" class="action-btn primary" (click)="addWorkflow()">
                  <span class="btn-icon">➕</span>
                  Add Workflow
                </button>
              </div>
              ...
              <div class="workflows-grid">
                <div *ngFor="let workflow of workflows(); let i = index" class="workflow-card">
                  <div class="workflow-header">
                    <div class="workflow-meta">
                      <input type="text" [(ngModel)]="workflow.name" placeholder="Workflow Name" class="workflow-title">
                      <select [(ngModel)]="workflow.type" class="workflow-type">
                        <option value="business">🏢 Business Process</option>
                        <option value="user">👤 User Journey</option>
                        <option value="system">⚙️ System Process</option>
                        <option value="approval">✅ Approval Flow</option>
                      </select>
                    </div>
                    <button type="button" class="remove-btn" (click)="removeWorkflow(i)">❌</button>
                  </div>

                  <div class="workflow-content">
                    <div class="form-group">
                      <label>Description:</label>
                      <textarea [(ngModel)]="workflow.description" placeholder="Describe this workflow..." class="form-control" rows="2"></textarea>
                    </div>

                    <div class="form-group">
                      <label>Trigger/Starting Point:</label>
                      <input type="text" [(ngModel)]="workflow.trigger" placeholder="What initiates this workflow?" class="form-control">
                    </div>

                    <div class="workflow-steps">
                      <label>Workflow Steps:</label>
                      <div class="steps-container">
                        <div *ngFor="let step of workflow.steps; let stepIndex = index" class="workflow-step">
                          <div class="step-number">{{stepIndex + 1}}</div>
                          <div class="step-content">
                            <input type="text" [(ngModel)]="step.title" placeholder="Step title" class="step-title">
                            <textarea [(ngModel)]="step.description" placeholder="Step description..." class="step-description" rows="2"></textarea>
                            <div class="step-meta">
                              <select [(ngModel)]="step.actor" class="step-actor">
                                <option value="user">👤 User</option>
                                <option value="system">⚙️ System</option>
                                <option value="admin">👨‍💼 Admin</option>
                                <option value="external">🌐 External Service</option>
                              </select>
                              <input type="text" [(ngModel)]="step.duration" placeholder="Duration" class="step-duration">
                            </div>
                          </div>
                          <button type="button" class="remove-step-btn" (click)="removeWorkflowStep(i, stepIndex)">🗑️</button>
                        </div>
                        <button type="button" class="add-step-btn" (click)="addWorkflowStep(i)">
                          <span class="btn-icon">➕</span>
                          Add Step
                        </button>
                      </div>
                    ...
                    <div class="workflow-outcomes">
                      <div class="form-group">
                        ...
                        <textarea [(ngModel)]="workflow.successOutcome" placeholder="What happens when this workflow completes successfully?" class="form-control" rows="2"></textarea>
                      </div>

                      <div class="form-group">
                        <label>Failure Scenarios:</label>
                        <textarea [(ngModel)]="workflow.failureScenarios" placeholder="What could go wrong? How are errors handled?" class="form-control" rows="2"></textarea>
                      </div>
                    </div>
                    ...
                    <div class="workflow-metadata">
                      <div class="meta-field">
                        ...
                        <select [(ngModel)]="workflow.priority" class="form-control">
                      ...
                      <div class="meta-field">
                        ...
                        <select [(ngModel)]="workflow.frequency" class="form-control">
                      ...
                      <div class="meta-field">
                        ...
                        <select [(ngModel)]="workflow.complexity" class="form-control">
                ...
                <div *ngIf="workflows().length === 0" class="empty-state">
                  ...
                  <p>Create workflows to document business processes and user journeys.</p>
                  <button type="button" class="action-btn primary" (click)="addWorkflow()">
                    <span class="btn-icon">➕</span>
                    Add First Workflow
                  </button>
...
export class ProjectDetailCleanComponent implements OnInit {
  ...
  addUserStory() {
    ...
    this.userStories.update(current => [...current, newStory]);
  }

  removeUserStory(index: number) {
    this.userStories.update(current => current.filter((_, i) => i !== index));
  }
  ...
  removeWorkflow(index: number) {
    this.workflows.update(current => current.filter((_, i) => i !== index));
  }

  addWorkflowStep(workflowIndex: number) {
    this.workflows.update(current => {
      const updated = [...current];
      updated[workflowIndex] = {
        ...updated[workflowIndex],
        steps: [...updated[workflowIndex].steps, {
          title: '',
          description: '',
          actor: 'user',
          duration: ''
  ...
  removeWorkflowStep(workflowIndex: number, stepIndex: number) {
    this.workflows.update(current => {
      const updated = [...current];
      updated[workflowIndex] = {
        ...updated[workflowIndex],
        steps: updated[workflowIndex].steps.filter((_, i) => i !== stepIndex)
      };
      return updated;
    });
  }
